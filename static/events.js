document.addEventListener("DOMContentLoaded", () => {
    ...
    // Change color to red over 5 seconds
...
$(document).ready(function () {
    ...
    // Generating slides
    let arrCities = ['24 Frames', 'Chess', 'Cyquest', 'Dexterity', 'Fotographia', 'Digital-Imaging', 'Programming', 'Quiz', 'Respawn-Console', 'Respawn-Mobile', 'Respawn-PC', 'Robowars', 'Scratch', 'Surprise']; // Change number of slides in CSS also
    ...
    $(document).on('click', '.event1', function () {
        ...
        // Add your functionality for event1 here
    });

    $(document).on('click', '.event2', function () {
        console.log("Event 2 triggered");
        // Add your functionality for event2 here
    });

    $(document).on('click', '.event3', function () {
        console.log("Event 3 triggered");
        // Add your functionality for event3 here
    });

    $(document).on('click', '.event4', function () {
        console.log("Event 4 triggered");
        // Add your functionality for event4 here
    });

    $(document).on('click', '.event5', function () {
        console.log("Event 5 triggered");
        // Add your functionality for event5 here
    });
});
