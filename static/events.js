...
$(document).ready(function () {
    ...
    // Generating slides
    let arrCities = ['24 Frames', 'Chess', 'Cyquest', 'Dexterity', 'Fotographia', 'Digi-Imaging', 'Programming', 'Quiz', 'RESPAWN+_+', 'RESPAWN-PC', 'RESPAWN._.', 'Robowars', 'Scratch', 'Surprise']; // Change number of slides in CSS also
